...
<div class="row">
  <div class="col-md-12">
    <div class="alert alert-danger alert-dismissible fade show">
      <strong>Alert !</strong>Scholarship for UnderGraduates and PostGraduates.
        ...
        <div class="row">
            ...
            <div class="col-md-4" style="margin-top: 10px;margin-left: 90px;">
              ...
              <a href="status.php" class="appointment-btn scrollto">
                <span class="d-none d-md-inline"></span>Check Status</a>
                <hr>
              <a href="feedback.php" class="appointment-btn scrollto">
                <span class="d-none d-md-inline"></span>Provide Feedback</a>
            </div>
        </div>
    </div>
