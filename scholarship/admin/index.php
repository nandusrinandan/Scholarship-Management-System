...
<?php    
	...
	if($numrow!=0)
	{
		...
		{
			$msg= "<h4 style='color:red;'>Incorrect Password </h4>";
		}
	}
	else
	{
		$msg= "<h4 style='color:red;'>Incorrect Username</h4>";
	}
                 }else{
                 $msg= "";
                 }
	...
	<div class="d-flex justify-content-center h-100">
		<div class="card">
			<div class="card-header">
				<h3><i class="fa fa-user-plus" aria-hidden="true"></i> RVCE Admin Login</h3>
			</div>
			<div class="card-body">
