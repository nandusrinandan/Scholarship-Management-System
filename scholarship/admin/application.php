                    ...
                    <div class="col-md-4">
                        <form method="post" action="action.php">
                            ...
                            <?php
                                ...
                                $text = 'Dear Scholarship Applicant,
Your application was evaluated by the scrutinizer and status has been set.
Please check your status by logging into your profile.
                                
                                
Regards,
Team Scholarship Management System';
                                mail($row['s_email'],$subject,$text);
                            ?>
                        </form>
                    </div>
