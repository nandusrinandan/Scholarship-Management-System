              ...
              <div class="form-row">
                <div class="col-md-12 form-group">
                  ...
                  <select name="scholar_category" class="form-control" required>
                    ...
                    <option value="SC ST OBC Scholarship">SC ST OBC Scholarships</option>
                  </select>
                </div>
              </div>
...
<div class="col-md-12 form-group">
                  Scholarship Code : <input type="text" class="form-control" name="s_code" placeholder="Scholarship Code" required>
                </div>
